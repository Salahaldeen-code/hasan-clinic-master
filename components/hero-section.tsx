      ...
      <div className="container relative mx-auto px-4 pt-20 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            ...
            {/* Stats Row */}
            <div
              className={`flex items-center gap-8 mt-12 animate-fade-in-up animation-delay-1400`}
            >
              <div className="text-center">
                <div className="text-3xl font-bold text-emerald-600 animate-count-up">
                  500+
                </div>
                <div className="text-sm text-gray-600">حالة ناجحة</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-teal-600 animate-count-up">
                  95%
                </div>
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/70 backdrop-blur-md rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-105">
                <img
                  src="/1.jpg"
            ...
            {/* Achievement Badge */}
            <div className="absolute top-1/2 -left-12 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-lg border border-gray-100 animate-bounce-slow hover:scale-105 transition-all duration-300">
